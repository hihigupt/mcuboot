...
// *
// Derives a DH key pair from the supplied value and label
//
...
// @return  - RIOT_SUCCESS
//
RIOT_STATUS RIOT_DeriveDHKeyPair(ecc_publickey *publicKey, ecc_privatekey *privateKey, bigval_t *srcVal, const uint8_t *label, size_t labelSize);
...
// @return  - RIOT_SUCCESS
//
RIOT_STATUS RIOT_DeriveDsaKeyPair(ecc_publickey *publicKey, ecc_privatekey *privateKey, bigval_t *srcVal, const uint8_t *label, size_t labelSize);
